...
import com.cj.ucapi.cloud.ConsulCloudServiceDiscovery;
import com.cj.ucapi.cloud.route.RibbonAlgorithm;
import com.cj.ucapi.cloud.route.RouterAlgorithm;
import com.cj.ucapi.encrypt.AESUtil;
import com.cj.ucapi.grpc.User;
import com.cj.ucapi.grpc.UserServiceGrpc;
...
import static com.cj.ucapi.message.Status.CONNECT_FAIL;
...
public class Client implements IClient {
    ...
    @Override
    public Result<Object> updateNickname(UpdateNicknameRequest req) {
        HandleRequest handleReq = buildHandleRequest("UpdateNickname", req);
        return request(handleReq, Object.class, r -> stub.handle(r));
    }

    @Override
    public Result<Object> updateProperties(UpdateNicknameRequest req) {
        HandleRequest handleReq = buildHandleRequest("UpdateProperties", req);
        return request(handleReq, Object.class, r -> stub.handle(r));
    }
