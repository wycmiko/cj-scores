...
public class ResultMsg {
    ...
    public static final String CART_NUMS_TOO_LESS = "数量不能再少了哦";
    public static final String CART_NUMS_TOO_MUCH = "数量不能再多了哦";
    ...
    public static final String EXPRESS_CANNOT_UPDATE = "当前状态无法添加/修改物流信息";

    public static final String MUST_POSITIVE_NUM = "金额必须为正数";
}
